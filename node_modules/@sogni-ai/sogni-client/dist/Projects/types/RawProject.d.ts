...
type RawProjectStatus = 'pending' | 'active' | 'assigned' | 'progress' | 'errored' | 'completed' | 'cancelled';
...
export type WorkerJobReason = 'artistCanceled' | 'artistDisconnected' | 'genfailure' | 'imgUploadFailure' | 'jobCompleted' | 'jobTimedOut' | 'workerDisconnected' | 'workerReconnected';
export type WorkerJobStatus = 'created' | 'queued' | 'assigned' | 'initiatingModel' | 'jobStarted' | 'jobProgress' | 'jobCompleted' | 'jobError';
