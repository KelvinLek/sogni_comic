...
function getControlNet(params) {
    ...
    if (params.strength !== undefined) {
        cn.controlStrength = (0, validation_1.validateNumber)(params.strength, {
            min: 0,
            max: 1,
    ...
    if (params.guidanceStart !== undefined) {
        cn.controlGuidanceStart = (0, validation_1.validateNumber)(params.guidanceStart, {
            min: 0,
            max: 1,
    ...
    if (params.guidanceEnd !== undefined) {
        cn.controlGuidanceEnd = (0, validation_1.validateNumber)(params.guidanceEnd, {
            min: 0,
            max: 1,
